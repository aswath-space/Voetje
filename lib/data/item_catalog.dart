...
class ItemCatalog {
  static const List<ShoppingItem> clothing = [
    ...
    ShoppingItem(name: 'Jeans', co2KgNew: 14.0, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing,
        synonyms: ['denim', 'trousers', 'pants']),
    ShoppingItem(name: 'Dress', co2KgNew: 10.0, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing),
    ShoppingItem(name: 'Jacket', co2KgNew: 12.0, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing,
        synonyms: ['coat', 'anorak']),
    ShoppingItem(name: 'Winter coat', co2KgNew: 20.0, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing,
        synonyms: ['coat', 'parka', 'puffer']),
    ShoppingItem(name: 'Sweater', co2KgNew: 12.0, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing,
        synonyms: ['jumper', 'pullover', 'knitwear']),
    ShoppingItem(name: 'Shoes', co2KgNew: 10.0, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing,
        synonyms: ['trainers', 'sneakers', 'boots', 'heels', 'footwear']),
    ShoppingItem(name: 'Underwear/socks pack', co2KgNew: 2.5, icon: Icons.checkroom_outlined, category: ShoppingCategory.clothing,
